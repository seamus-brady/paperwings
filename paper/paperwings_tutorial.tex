...
\textit{PaperWings}\footnote{\url{https://github.com/seamus-brady/paperwings}} fills this gap. It is a pure-Python (NumPy) library that implements the three most common VSA families, wraps them in an associative memory with biologically-motivated forgetting, and provides a triple-unbinding algorithm for knowledge graph recovery. This paper introduces the necessary background, describes the library architecture, and presents worked examples.
...
\textit{torchhd} \citep{heddes2023} provides a PyTorch-based library supporting BSC, MAP, HRR, and several other families with GPU acceleration. \textit{OpenHD} \citep{kang2022} targets GPU-accelerated classification workloads. \citet{schlegel2022} provide a comprehensive comparative survey of VSA families, evaluating their properties and trade-offs across a range of tasks. The library presented here complements these by prioritising pedagogical clarity and minimal dependencies.
...
5  & 25  & 28.7 \\
10 & 50  & 8.2 \\
$\sim$22 & $\sim$110 & $\approx 0.5$ (deleted) \\
\bottomrule
\end{tabular}
\end{table}
...
\bibitem[{PaperWings}(2025)]{paperwings2025}
{PaperWings} (2025).
\newblock {PaperWings}: A Python library for vector symbolic architectures.
\newblock \url{https://github.com/seamus-brady/paperwings}.
